...
export const vehicleData: Record<VehicleTypeKey, VehicleConfig> = {
  car: {
    ...
    models: {
      ...
      Cupra: ["Ateca", "Born", "Formentor", "Leon", "Tavascan", "Terramar", "Terramar PHEV"],
      Dacia: [
        "Bigster",
        "Bigster (2025)",
        "Dokker",
      ...
      Haval: ["H6", "H6 GT", "Jolion", "H2", "H9", "Dargo", "Dargo X", "Inny model"],
      Honda: [
        "Accord",
        "CR-V",
        "CR-V e:PHEV",
      ...
      "Land Rover": [
        ...
        "Range Rover Velar",
        "Range Rover Velar (2024 facelift)",
      ],
      Lexus: [
        "CT",
        "ES",
      ...
      Polestar: ["1", "2", "3", "4", "5", "6", "Inny model"],
      Porsche: [
        "718",
        "911",
        "911 Dakar",
      ...
      SsangYong: ["Tivoli", "Korando", "Rexton", "Musso", "Torres", "Torres EVX", "Torres EVX (2024)", "Inny model"],
      ...
      Chery: ["Tiggo 4 Pro", "Tiggo 7 Pro", "Tiggo 8 Pro", "Arrizo 6 Pro", "Inny model"],
      Jaecoo: ["J7", "J8", "Inny model"],
      Leapmotor: ["C10", "C01", "T03", "B10", "Inny model"],
      "Lynk & Co": ["01", "02", "05", "06", "Inny model"],
      Nio: ["ET5", "ET5 Touring", "ET7", "EL6", "ES6", "ES8", "EL7", "Inny model"],
      Omoda: ["5", "5 EV", "7", "E5", "Inny model"],
      Ora: ["Funky Cat", "03", "Inny model"],
      Seres: ["3", "5", "Inny model"],
      Tank: ["300", "400", "500", "Inny model"],
      Vinfast: ["VF 6", "VF 7", "VF 8", "VF 9", "Inny model"],
      Xpeng: ["G6", "G9", "P7", "X9", "Inny model"],
      Zeekr: ["001", "007", "009", "X", "Inny model"],
      Bentley: ["Bentayga", "Continental GT", "Flying Spur", "Mulliner", "Inny model"],
      Lamborghini: ["Huracan", "Urus", "Revuelto", "Inny model"],
      Ferrari: ["Roma", "Portofino", "SF90", "296 GTB", "Purosangue", "Inny model"],
      "Rolls-Royce": ["Ghost", "Phantom", "Cullinan", "Spectre", "Inny model"],
      "Aston Martin": ["DB11", "DBX", "Vantage", "DBS", "Inny model"],
      Lotus: ["Emira", "Eletre", "Emeya", "Inny model"],
      McLaren: ["720S", "Artura", "GT", "GTS", "Inny model"],
      Cadillac: ["CT4", "CT5", "Escalade", "XT4", "XT5", "XT6", "Lyriq", "Inny model"],
      Lincoln: ["Aviator", "Corsair", "Navigator", "Nautilus", "Inny model"],
      Buick: ["Encore GX", "Envision", "Enclave", "Inny model"],
      GMC: ["Sierra", "Yukon", "Terrain", "Acadia", "Canyon", "Inny model"],
      Lada: ["Granta", "Vesta", "Niva", "Largus", "Inny model"],
